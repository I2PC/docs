...
.. note::
  For faster and more efficient dependency resolution in Conda environments, it is highly recommended to use LibMamba. In Conda 23 and later, LibMamba is enabled by default. For earlier versions, it can be `installed and configured manually to achieve faster environment solving <https://www.anaconda.com/blog/a-faster-conda-for-a-growing-community>`_
