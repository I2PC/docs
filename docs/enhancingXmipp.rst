...
We understand some users may have privacy concerns. Therefore, Xmipp includes an option to disable data collection. Users can easily opt-out by setting the variable SEND_INSTALLATION_STATISTICS to OFF in your OS.
