...
latex_documents = [
    (master_doc, 'xmipp.tex', u'Xmipp Documentation',
     u'Xmipp team', 'manual'),
]
...
man_pages = [
    (master_doc, 'xmipp', u'Xmipp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Xmipp', u'Xmipp Documentation',
     author, 'Xmipp', 'One line description of project.',
     'Miscellaneous'),
]
