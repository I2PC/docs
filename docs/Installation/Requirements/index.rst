...
- XMIPP_CUDA_BIN (`Scipion configuration file <https://scipion-em.github.io/docs/release-3.0.0/docs/scipion-modes/scipion-configuration.html>`_) ``CUDA_BIN=/usr/local/cuda/bin/``
