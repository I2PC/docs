...
.. note::
   ...
   This `list of libraries <https://i2pc.github.io/docs/Installation/Requirements/index.html#dependencies-automatically-installed-via-scipion>`_ are required in standlone installation and you can install it in the Scipion eviroment if you choose the option 1 to compile Xmipp or in the system for option 2 (see options below)
